...
(function(h,d,e){
        ...
        d.infinitescroll.prototype={
                _binding:function(a){
                        ...
                        b.v="2.0b2.111027";
                        if(b.behavior&&this["_binding_"+b.behavior]!==e)this["_binding_"+b.behavior].call(this);
                        else{
                                if("bind"!==a&&"unbind"!==a)return this._debug("Binding value  "+
                                        a+" not valid"),!1;
                                if("unbind"==a)this.options.binder.unbind("smartscroll.infscr."+c.options.infid);else this.options.binder[a]("smartscroll.infscr."+c.options.infid,function(){
                                        c.scroll()
                                        });
        ...
        _debug:function(){
                if(this.options&&this.options.debug)return h.console&&console.log.call(console,arguments)
                        },
...
_loadcallback:function(a,c){
        ...
        if(b.behavior&&
                this["_loadcallback_"+b.behavior]!==e)this["_loadcallback_"+b.behavior].call(this,a,c);
        else{
                switch(f){
                        case "done":
                        ...
                        case "append":
                                var i=a.children();
                                if(0==i.length)return this._error("end");
                        ...
                        b);
                b.animate&&(f=d(h).scrollTop()+d("#infscr-loading").height()+b.extraScrollPx+"px",d("html,body").animate({
                        scrollTop:f
                },800,function(){
...
_nearbottom:function(){
        ...
        if(a.behavior&&this["_nearbottom_"+a.behavior]!==e)return this["_nearbottom_"+a.behavior].call(this);
        this._debug("math:",c,a.pixelsFromNavToBottom);
        return c-a.bufferPx<a.pixelsFromNavToBottom
        },
_pausing:function(a){
        var c=this.options;
        if(c.behavior&&this["_pausing_"+c.behavior]!==e)this["_pausing_"+c.behavior].call(this,a);
        else{
...
_setup:function(){
        var a=this.options;
        if(a.behavior&&
                this["_setup_"+a.behavior]!==e)this["_setup_"+a.behavior].call(this);else return this._binding("bind"),!1
                },
_showdonemsg:function(){
        var a=this.options;
        a.behavior&&this["_showdonemsg_"+a.behavior]!==e?this["_showdonemsg_"+a.behavior].call(this):(a.loading.msg.find("img").hide().parent().find("div").html(a.loading.finishedMsg).animate({
                opacity:1
        },2E3,function(){
...
_validate:function(a){
        for(var c in a)if(c.indexOf&&
                -1<c.indexOf("Selector")&&0===d(a[c]).length)return this._debug("Your "+c+" found no elements."),!1;return!0
        },
bind:function(){
        this._binding("bind")
        },
...
retrieve:function(a){
        ...
        beginAjax=function(a){
                ...
                switch(j){
                        ...
                        break;
                case "json":
                        c._debug("Using "+j.toUpperCase()+" via $.ajax() method"),d.ajax({
                        dataType:"json",
                        type:"GET",
                        url:i,
...
if(b.behavior&&this["retrieve_"+b.behavior]!==e)this["retrieve_"+b.behavior].call(this,a);
else{
...
d.fn.infinitescroll=function(a,c){
        switch(typeof a){
                case "string":
                        ...
                        if(!c||!d.isFunction(c[a])||"_"===a.charAt(0))return!1;
                        c[a].apply(c,b)
                        });
                break;
                case "object":
        ...
        f.fn=f.prototype={
                ...
                css:function(a,c){
                        ...
                        if("string"===typeof a){
                                ...
                                e.style[a]=c
                                }else for(d in a)e.style[d]=a[d];return this
                        },
                show:function(){
...
f.removeData=function(a,c){
        ...
        if(n)if(c){
                delete n[c];
                for(var k in n)d=!1;d&&delete f.cache[m]
                ...
                if(k)if(c){
                        if(b=k[c]){
                                ...
                                if(0===b.listeners.length){
                                        ...
                                        delete k[c];
                                        b=f.data(a,"@events");
                                        for(var r in b)n=!1;n&&f.removeData(a,"@events")
                                        }
                                }
...
(function(g,h,i){
        ...
        var f,p=0,o="artDialog"+ +new Date,a=h.VBArray&&!h.XMLHttpRequest,c="createTouch"in document&&!("onmousemove"in document)||/(iPhone|iPad|iPod)/i.test(navigator.userAgent),d=!a&&!c,e=function(b,a,n){
                ...
                for(t in k)b[t]===i&&(b[t]=k[t]);b.id=r&&
                r[o+"follow"]||b.id||o+p;
        ...
        e.fn=e.prototype={
                ...
                content:function(b){
                        ...
                        else if(b&&1===b.nodeType)d=b.style.display,a=b.previousSibling,c=b.nextSibling,e=b.parentNode,this._elemBack=function(){
                ...
                close:function(){
                        ...
                        if(f)a.remove();
                                ...
                                for(var h in this)this.hasOwnProperty(h)&&"dom"!==h&&delete this[h];this.hidden()
                                }
                                this.closed=!0;
                        return this
                        },
