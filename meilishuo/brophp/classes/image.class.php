 ...
 * ******************************************************************************/
	class Image {
		...
		*/ 
		...
		protected function position($groundInfo, $waterInfo, $waterPos){
		...
		// 获取图片的信息
		protected function getInfo($name, $path=".") {
		...
		// 创建图像资源 
		protected function getImg($name, $imgInfo, $path='.'){
		...
		protected function getNewSize($name, $width, $height,$imgInfo){	
		...
		protected function createNewImage($newImg, $newName, $imgInfo){
		...
		protected function copyImage($groundImg, $waterImg, $pos, $waterInfo){
